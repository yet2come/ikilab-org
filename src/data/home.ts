export const homeData = {
  ...
  experiments: {
    ...
    items: [
      ...
      { status: "active", title: "壱岐市 人口シミュレーション", body: "2つの異なるアプローチで壱岐市の人口問題の「想定される未来」を動的に可視化。市民が当事者意識を持てる体感型シミュレーションを目指す。", href: "/projects/iki-pop-sim" },
      ...
      { status: "planned", title: "壱岐ロケ", body: "地域主体で場所の情報を整備し、観光・生活・地域活動に使えるロケーションデータ基盤をつくる取り組み。", href: "/projects/iki-loc" },
